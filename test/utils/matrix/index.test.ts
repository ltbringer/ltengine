...
describe('matrix.merge', () => {
  it.each([
    {
      description:
        'should merge a 3x3 matrix of 0 values into a 3x3 matrix of 1 values at (1, 1)',
    ...
    {
      description:
        'should merge a 3x3 matrix of 0 values into a 3x3 matrix of 1 values at (0, 0)',
      m1: { rows: 3, cols: 3, value: 0 },
      m2: { rows: 2, cols: 2, value: 1 },
      position: { x: 0, y: 0 },
      expected: [
    ...
    {
      description:
        'should throw MatrixOverflow when merging a 2x2 matrix of 1 values into a 3x3 matrix at (2, 2)',
      m1: { rows: 3, cols: 3, value: 0 },
      m2: { rows: 2, cols: 2, value: 1 },
      position: { x: 2, y: 2 },
      expectError: true,
